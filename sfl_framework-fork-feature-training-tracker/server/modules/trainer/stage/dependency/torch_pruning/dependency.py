...
class Group(object):
    ...
    def __init__(self):
        ...
        self._pruned_idxs = list() # the indices that have been pruned
    ...
    def restore(self):  
        """Restore all coupled layers in the group
        """
        ...
        for dep, idxs in self._group:
            ...
            # print(len(curr_parameter.weight), len(idxs))
            if prune_fn in [
                function.prune_conv_out_channels,
                function.prune_linear_out_channels,
            ]:  
                if hasattr(layer, "transposed") and layer.transposed:
                    w = layer.weight.data.transpose(1, 0)
                else:
                    w = layer.weight.data
                ...
                if hasattr(layer, "transposed") and layer.transposed:
                    ...
                    w = (layer.weight.data).transpose(0, 1)
