...
class MobileNetSplitter(BaseSplitter):
    def __init__(self, config: "Config", strategy: "BaseStrategy"):
        self.config = config
        self.strategy = strategy

    def split(self, model: "Module", params: dict):
        not_splitable_modules = tuple([InvertedResidual, Conv2dNormActivation])
        params["not_splitable_modules"] = not_splitable_modules
